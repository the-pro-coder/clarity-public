  ...
  return (
    <section className="flex">
      <div className="flex-1 max-w-1/2 max-sm:max-w-full max-sm:items-center flex flex-col pt-10">
        <h1 className="w-[90%] max-w-full text-nowrap flex flex-col pl-14 max-sm:pl-2">
          <span className="text-[clamp(30px,4.3vw,90px)] ">
            Learning that adapts
          </span>
          <span className="text-[clamp(50px,7vw,130px)] lg:leading-20 lg:mb-4 font-bold max-sm:leading-10 text-primary xl:leading-30">
            to your mind
          </span>
        </h1>
